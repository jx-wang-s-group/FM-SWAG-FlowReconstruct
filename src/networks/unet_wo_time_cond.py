...
## Modified by removing time dependecy to use it as a standard regression neural operator
...
class UNetModelWrapperWOTime(UNetModel):
    def __init__(
        self,
        dim,
        num_channels,
        ...
        if channel_mult is None:
            ...
            channel_mult = tuple(map(int, channel_mult.split(', '))) if isinstance(channel_mult, str) else channel_mult
        ...
        return super().__init__(
            ...
            out_channels= out_dim if out_dim is not None else dim[0],
